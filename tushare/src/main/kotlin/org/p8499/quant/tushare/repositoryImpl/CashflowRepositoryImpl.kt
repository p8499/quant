...
class CashflowRepositoryImpl : CashflowDao {
    ...
    override fun get(stockId: String, date: LocalDate): Cashflow? = em
    ...
    override fun findByStockIdBetween(stockId: String, from: LocalDate, to: LocalDate): List<Cashflow> = em

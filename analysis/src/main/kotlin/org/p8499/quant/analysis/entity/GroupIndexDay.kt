...
@Entity
@Table(name = "GID")
@IdClass(GroupIndexDay.GroupIndexDayId::class)
open class GroupIndexDay(
        @Id
...
//        @Temporal(TemporalType.DATE)
    ...
    open class GroupIndexDayId(
            open var region: String? = null,
            open var id: String? = null,
            open var kpi: String? = null,
            open var date: LocalDate? = null) : Serializable {
        override fun hashCode(): Int = Objects.hash(region, id, kpi, date)
        override fun equals(other: Any?): Boolean = other is GroupIndexDayId && other.region == region && other.kpi == kpi && other.date == date
    }
}